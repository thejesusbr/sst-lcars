...
let lcarsAudio = {
  ...
  initialize: function (auDummy) {
    ...
    this.audTactInputAcknowledge = new Audio(
      "audio/computerbeep_17." + this.audioType
    );
    this.audTactInputAltAcknowledge = new Audio(
      "audio/tactinput_alt_acknowledge." + this.audioType
    );
    this.audTactInputNegAcknowledge = new Audio(
      "audio/tactinput_neg_acknowledge." + this.audioType
    );
    ...
    button_list = document.querySelectorAll(
      "#container div.lcars-elbow.button, div.lcars-app-container div.lcars-elbow.button"
    );
    for (var button of button_list) {
      console.log(
        "Audio-enabling container-contained button " +
    ...
    button_list = document.querySelectorAll("lcars-element[button]");
    for (var button of button_list) {
      console.log(
    ...
    for (var button of button_list) {
      console.log(
        "Audio-enabling button " + button.id + " " + button.innerText
      );
      button.addEventListener("click", function () {
        lcarsAudio.TactileInputAcknowledge();
      });
    ...
    for (var button of button_list) {
      console.log(
        "Audio-enabling range slider " + button.id + " " + button.name
      );
      button.addEventListener("click", function () {
        lcarsAudio.TactileInputAcknowledge();
      });
