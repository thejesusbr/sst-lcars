...
onMounted(() => {
  register(elementId.value, null, { type: 'defaultBarFrame', namespace: 'sdk', ...props })
})
...
<template>
  ...
  >
    ...
    <header class="row">
      <LcarsCap
        version="round-left"
        :color="coloring?.headerCapLeft || 'bg-'"
        no-event
      />
      ...
      >
        ...
        <LcarsTitle
          ...
          :text="label"
          :color="coloring?.headerTitle || 'text-white'"
          no-event
        />
      </LcarsRow>
    ...
    <footer class="row">
      <LcarsCap
        version="round-left"
        :color="coloring?.footerCapLeft || 'bg-'"
        no-event
      />
      ...
      >
        <LcarsTitle
          ...
          :text="altLabel"
          :color="coloring?.footerTitle || 'text-white'"
          no-event
        />
      ...
      <LcarsCap
        version="round-right"
        :color="coloring?.footerCapRight || 'bg-'"
        no-event
      />
    </footer>
  </div>
