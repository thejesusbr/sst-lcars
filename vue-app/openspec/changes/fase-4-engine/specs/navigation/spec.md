...
Warp travel SHALL NOT deduct `mainEnergy` directly (unlike the classic game, which
used `E=E-N-10`) — its cost is instead paid in Warp Core stress: warp factor 4 and
